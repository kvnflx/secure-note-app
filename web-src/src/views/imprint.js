export function renderImprint(root) {
  root.innerHTML = `
    <section class="page legal">
      ...
      <p>
        Kevin Felix<br>
        Backsafe – IT-Dienstleistungen<br>
        Saarbrücker Str. 21A<br>
      ...
      <p>USt-IdNr.: DE420785710</p>

      <h2>Berufsbezeichnung</h2>
      <p>
        Berufsbezeichnung: Fachinformatiker für Systemintegration<br>
        Verliehen in: Deutschland
      </p>

      <h2>Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
      <p>Kevin Felix, Anschrift wie oben.</p>
      ...
      <p class="muted-small">Letzte Aktualisierung: April 2026</p>
    </section>
  `;
}
